...
use crate::endpoint::{EndpointDriverFactory, EndpointDriverRegistryError, EndpointGroupId};
...
use crate::session::{
    OperatorId, SessionEngineBuilder, DEFAULT_MULTISTEM_RECORDING_GROUP_ID, RECORDER_NODE_TYPE_ID,
...
impl SessionEngineBuilder {
    ...
    ) -> Result<SessionRecordingReceipt, EndpointDriverRegistryError> {
