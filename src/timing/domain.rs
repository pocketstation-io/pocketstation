...
pub enum ClockDomainOrigin {
    #[doc = "Selects the unspecified case of `ClockDomainOrigin`."]
    Unspecified,
    #[doc = "Selects the process start case of `ClockDomainOrigin`."]
    ProcessStart,
    #[doc = "Selects the provider defined case of `ClockDomainOrigin`."]
    ProviderDefined,
}
...
impl ClockDomainDescriptor {
    #[doc = "Returns the id held by `ClockDomainDescriptor`."]
    pub const fn id(self) -> ClockDomainId {
        self.id
    }

    #[doc = "Returns the kind represented by `ClockDomainDescriptor`."]
    pub const fn kind(self) -> ClockDomainKind {
        self.kind
    }

    #[doc = "Returns the origin held by `ClockDomainDescriptor`."]
    pub const fn origin(self) -> ClockDomainOrigin {
        self.origin
    }

    #[doc = "Returns the tick rate hertz held by `ClockDomainDescriptor`."]
