...
| DHAT allocation check | RESOLVED | audio-core / tools/pocketstation-alloccheck | replaced with `assert_no_alloc = "1.1"` crate; NIH counting allocator removed (PR: refactor/wave4-assert-no-alloc) | — | — |
