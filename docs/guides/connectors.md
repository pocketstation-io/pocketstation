...
<!-- claims: CLM-GUIDE-015-SCOPE-001,CLM-GUIDE-015-TEXT-001,CLM-GUIDE-015-TEXT-002,CLM-GUIDE-015-TEXT-003,CLM-GUIDE-015-TEXT-004,CLM-GUIDE-015-TEXT-005,CLM-GUIDE-015-TEXT-006,CLM-GUIDE-015-SOURCE-001 -->
...
This is the frozen, repository-owned example `example-937ee5ed9d4dfb93965f` at `examples/connector_authoring.rs`. It is validated by the examples checkpoint.
...
- `examples/connector_authoring.rs:1-21` (`DIRECT`)
