...
| `canonical_path` | function | Returns the canonical path associated with `NativeExtensionLibrary`. | `src/native_extension/mod.rs:68` |
| `code` | function | Returns the stable error or status code represented by `NativeExtensionLibraryError`. | `src/native_extension/mod.rs:131` |
| `generation` | function | Returns the generation associated with `NativeExtensionRegistration`. | `src/native_extension/mod.rs:54` |
| `id` | function | Returns the id associated with `NativeExtensionRegistration`. | `src/native_extension/mod.rs:42` |
| `kind` | function | Returns the kind represented by `NativeExtensionRegistration`. | `src/native_extension/mod.rs:46` |
| `message` | function | Returns the diagnostic message associated with `NativeExtensionLibraryError`. | `src/native_extension/mod.rs:135` |
...
| `path` | function | Returns the path associated with `NativeExtensionLibraryError`. | `src/native_extension/mod.rs:139` |
| `registrations` | function | Returns the registrations associated with `NativeExtensionLibrary`. | `src/native_extension/mod.rs:72` |
| `revision` | function | Returns the revision associated with `NativeExtensionRegistration`. | `src/native_extension/mod.rs:50` |
...
| `pocketstation::native_extension::NativeExtensionRegistration` | struct | Represents native extension registration in the PocketStation API. | `src/native_extension/mod.rs:34` |
...
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::DuplicateRegistration` | variant | Reports duplicate registration. | `src/native_extension/mod.rs:92` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::EntrypointFailed` | variant | Reports entrypoint failed. | `src/native_extension/mod.rs:85` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::EntrypointMissing` | variant | Reports entrypoint missing. | `src/native_extension/mod.rs:83` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::EntrypointPanicked` | variant | Reports entrypoint panicked. | `src/native_extension/mod.rs:84` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::InvalidLibraryDescriptor` | variant | Reports invalid library descriptor. | `src/native_extension/mod.rs:88` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::InvalidRegistration` | variant | Reports invalid registration. | `src/native_extension/mod.rs:91` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::LibraryLoadFailed` | variant | Reports library load failed. | `src/native_extension/mod.rs:82` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::PathCanonicalizationFailed` | variant | Reports path canonicalization failed. | `src/native_extension/mod.rs:80` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::PathNotAbsolute` | variant | Reports path not absolute. | `src/native_extension/mod.rs:79` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::PathNotFile` | variant | Reports path not file. | `src/native_extension/mod.rs:81` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::RegistrationAcquisitionFailed` | variant | Reports registration acquisition failed. | `src/native_extension/mod.rs:90` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::RegistrationAcquisitionPanicked` | variant | Reports registration acquisition panicked. | `src/native_extension/mod.rs:89` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::RegistrationStateUnavailable` | variant | Reports registration state unavailable. | `src/native_extension/mod.rs:93` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::UnsupportedAbiMajor` | variant | Reports unsupported ABI major. | `src/native_extension/mod.rs:86` |
| `pocketstation::native_extension::NativeExtensionLibraryErrorCode::UnsupportedAbiMinor` | variant | Reports unsupported ABI minor. | `src/native_extension/mod.rs:87` |
