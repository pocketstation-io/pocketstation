...
Supervise connector delivery, acknowledgement, retry budgets, readiness, cancellation, drain, and abort.
...
| `pocketstation::connector::worker::ConnectorRunOutcome` | struct | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/mod.rs:42` |
| `pocketstation::connector::worker::coordination::ConnectorContext` | struct | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/coordination.rs:14` |
| `ConnectorWorker::cancel_preparation` | function | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/mod.rs:35` |
| `ConnectorWorker::run` | function | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/mod.rs:33` |
| `pocketstation::connector::worker::driver::ConnectorDeliveryOutcome::Delivered` | variant | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/driver.rs:84` |
| `pocketstation::connector::worker::driver::ConnectorDeliveryOutcome::Dropped` | variant | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/driver.rs:85` |
| `pocketstation::connector::worker::driver::ConnectorItem::Audio` | variant | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/driver.rs:63` |
| `pocketstation::connector::worker::driver::ConnectorItem::Signal` | variant | The compiler exposes this declaration; its native description remains a Gate 9 obligation. | `src/connector/worker/driver.rs:67` |
