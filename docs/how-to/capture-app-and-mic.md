...
<!-- claims: CLM-GUIDE-003-SCOPE-001,CLM-GUIDE-003-TEXT-001,CLM-GUIDE-003-TEXT-002,CLM-GUIDE-003-TEXT-003,CLM-GUIDE-003-TEXT-004,CLM-GUIDE-003-TEXT-005,CLM-GUIDE-003-TEXT-006,CLM-GUIDE-003-SOURCE-001 -->
...
- `pocketstation::session::lifecycle::host::SessionEngineHostBuildError` / `MissingApplicationBackend` — `error-401b27cb4ab9b018bed7`
- `pocketstation::session::lifecycle::host::SessionEngineHostBuildError` / `MissingMicrophoneBackend` — `error-b8af8e117cd3a5494a28`
...
The claims on **Capture application and microphone stems** are anchored to Git snapshot `136e74888962558aa846d3143a19136a70936f45` and these primary files:
