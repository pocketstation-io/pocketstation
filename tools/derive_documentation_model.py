...
CAPABILITY_SPECS = [
    ...
    ("CAP-022", "Run connector workers", "Supervise connector delivery, acknowledgement, retry budgets, readiness, cancellation, drain, and abort.", ["connector", "endpoint"], ["src/connector/worker/supervisor.rs", "src/connector/worker/driver.rs", "src/connector/readiness.rs"], True, True),
    ...
    ("CAP-031", "Validate protocol and conformance boundaries", "Check ABI layout, cross-language behavior, connector vectors, and protocol compatibility against versioned fixtures.", ["abi", "connector", "repository"], ["src/conformance.rs", "tests/protocol_compatibility.rs", "tests/abi_session_c_conformance.rs"], True, True),
...
TERM_SPECS = [
    ...
    ("audio reentry", "AudioReentryBridge", "audio reentry", "The bounded crossing that returns asynchronously generated PCM to the audio lane.", ["Bridge"], [], ["operator"]),
    ...
    ("retry budget", "RetryBudget", "retry budget", "A finite connector limit on retry attempts or elapsed retry work.", [], ["infinite retry"], ["connector"]),
...
GATE7 = [
    ...
    ("DOC-035", "Conformance and qualification", "docs/concepts/conformance.md", "concept", ["abi", "connector", "repository"], ["CAP-031"], ["src/conformance.rs", "tests/protocol_compatibility.rs"]),
...
GATE8 = [
    ...
    ("GUIDE-025", "Run protocol checks", "docs/how-to/run-protocol-checks.md", ["repository", "release", "abi", "connector"], ["CAP-031", "CAP-032"], ["scripts/check_protocol.sh"]),
...
GATE10 = [
    ...
    ("TRBL-013", "A conformance check cannot find external fixtures", "docs/troubleshooting/conformance-fixtures.md", "troubleshooting", ["abi", "connector", "repository"], ["CAP-031", "CAP-032"], ["tests/connector_portable_semantics.rs", "scripts/check_protocol.sh"]),
    ...
    ("BEST-005", "Use finite connector retry budgets", "docs/best-practices/connector-retries.md", "best-practice", ["connector"], ["CAP-021", "CAP-022", "CAP-026"], ["src/connector/manifest.rs", "src/connector/worker/coordination.rs"]),
