...
//!
//! The checked header is `include/pks_codec.h`. Regenerate it with
//! `scripts/sync-codec-c-header.sh` after changing this file.
//!
//! Canonical SDK copies use the same `pks_codec.h` name:
//!   sdk-ios/Sources/PocketStationCodecFFI/pks_codec.h
//!   sdk-android/sdk/src/main/cpp/pks_codec.h
